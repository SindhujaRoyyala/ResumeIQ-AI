...
def compute_ats_score(resume_text: str, job_desc: str = '') -> dict:
    """Compute ATS score and matched/missing keywords."""
...
def get_ai_suggestions(raw_text: str, job_desc: str, missing_keywords: list) -> list:
    """Generate basic AI suggestions based on missing keywords.

    This placeholder implementation creates simple suggestion strings for each missing keyword.
    In a production system, this could call an LLM or external service.
    """
    suggestions = []
    for kw in missing_keywords:
        suggestions.append(f"Consider adding experience or details related to '{kw}'.")
    return suggestions
